---
name: distributed-worklog
description: Parallel subagent scratch files → atomic merge pattern. Prevents merge conflicts when multiple agents write to a shared worklog.
---
